...
export default {
    ...
    data() {
        ...
        return {
            contactLocal: { ...this.contact }, // Sử dụng spread operator để tạo bản sao
            contactFormSchema,
        };
    },
    methods: {
        ...
        Cancel() {
            const reply = window.confirm('Bạn có thay đổi chưa lưu! Bạn có muốn rời đi không?');
            if (!reply) {
                return false; // Duy trì trang nếu người dùng nhấp 'Cancel'
            } else {
